...
* The original package name 'com.revined.spring-boot' is invalid and this project uses 'com.revined.springboot' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.0.0-SNAPSHOT/reference/htmlsingle/#howto.data-initialization.migration-tool.flyway)
